...
namespace BrickShooter 
{
    ...
    std::vector<Enemy*> CollisionHandler::enemies;
    std::vector<Shot*> CollisionHandler::shots;
    std::vector<Shot*> CollisionHandler::shotsToRemove;

    CollisionHandler::CollisionHandler() {
        enemyCollisionClock = std::make_unique<Clock>();
    }
