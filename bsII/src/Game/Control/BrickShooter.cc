...
namespace BrickShooter
{
    ...
    std::vector<Enemy *> BrickShooter::enemies;
    std::vector<Thread *> BrickShooter::enemiesThreads;
    ...
    void BrickShooter::init() {
        ...
        enemies.push_back(new Enemy(Enemy::Algorithm::A, player,
                                    Point(100, Config::playableAreaHeight - 100 - 2 * Enemy::ENEMY_SIZE)));
        enemies.push_back(new Enemy(Enemy::Algorithm::D, player,
                                    Point(Config::playableAreaWidth - 100 - Enemy::ENEMY_SIZE, 100)));
        enemies.push_back(new Enemy(Enemy::Algorithm::B, player,
                                    Point(Config::playableAreaWidth - 100 - Enemy::ENEMY_SIZE,
                                          Config::playableAreaHeight - 100 - 2 * Enemy::ENEMY_SIZE)));
    ...
    void BrickShooter::restart() {
        ...
        enemies[3]->setPosition(Point(Config::playableAreaWidth - 100 - Enemy::ENEMY_SIZE,
                                      Config::playableAreaHeight - 100 - 2 * Enemy::ENEMY_SIZE));
        enemies[3]->previousPosition = Point(Config::playableAreaWidth - 100 - Enemy::ENEMY_SIZE,
                                             Config::playableAreaHeight - 100 - 2 * Enemy::ENEMY_SIZE);
